...
public class Ranking extends javax.swing.JFrame {
    ...
    /**
     * Constructor con lista de jugadores reales
     */
  

    // Clase interna para el renderer personalizado
    private class JugadorListCellRenderer extends JLabel implements ListCellRenderer<Jugador> {
        public JugadorListCellRenderer() {
            setOpaque(true);
            setFont(new java.awt.Font("Pixeloid Sans", 1, 36));
            setForeground(Color.WHITE);
            setBackground(new Color(7, 88, 119));
        }
        ...
        public Component getListCellRendererComponent(JList<? extends Jugador> list, Jugador jugador, 
            ...
            // Formato: "1. Arturo - puntos: 2354"
            String texto = String.format("%d. %s - puntos: %d", 
                                        index + 1, 
                                        jugador.getNombre(), 
            ...
            if (isSelected) {
                setBackground(new Color(10, 120, 160)); // Color cuando está seleccionado
            } else {
                setBackground(new Color(7, 88, 119)); // Color normal
            }
    ...
    private void initComponents() {
        ...
        menuText.setFont(new java.awt.Font("Pixeloid Sans", 3, 150)); // NOI18N
        menuText.setForeground(new java.awt.Color(255, 255, 255));
        menuText.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        menuText.setText("EN DESARROLLO");
        jPanel1.add(menuText, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 160, 1620, 760));

        menuText1.setFont(new java.awt.Font("Pixeloid Sans", 0, 100)); // NOI18N
        menuText1.setForeground(new java.awt.Color(255, 255, 255));
        menuText1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        menuText1.setText("RANKINGS");
        jPanel1.add(menuText1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 60, 800, 190));
